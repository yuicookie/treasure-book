...
{
id: 'tr_ch87',
name: '매화단청 쿠키의 매화단청 여의주',
rarity: 'S',
canEvolve: false,
effect: '강화 수치에 따라 매화 젤리 1000~3000점 추가\n강화 수치에 따라 매화코인 젤리 3000~5000점 추가',
method: '매화단청 쿠키 레벨 8 달성시 획득',
description: '매화단청 쿠키의 매화단청 용이 품고 있는 여의주.\n추운 겨울의 냉기를 이겨내고 피어난, 귀하디 귀한설중매가 단청 구슬로 빚어져 더욱 아름답다.\n어떤소원이든 이룰 수 있는 힘을 가졌지만, 어느 누구도 감히 그 여의주에 손을 뻗지는 못한다고.'
},
{
id: 'tr_ch88',
name: '가래떡맛 쿠키의 지하여장군 소시지',
rarity: 'S',
canEvolve: false,
effect: '강화 수치에 따라 장애물 통과시 4300~7000점 추가\n강화 수치에 따라 가래떡 젤리 1500~2500점 추가',
method: '가래떡맛 쿠키 레벨 8 달성시 획득',
description: '마을을 지키느라 밤낮없이 수고하는 가래떡맛 쿠키를 위해, 마을 쿠키들이 만들어준 지하여장군 소시지.\n지하여장군을 본떠 만들어 한 입만 베어 물어도 수호의 힘이 불끈!'
},
{
id: 'tr_pet01',
...
rarity: 'S',
canEvolve: false,
effect: '강화 수치에 따라 아몬드 젤리 1500~3500점 추가',
method: '솟대 가족 레벨 8 달성시 획득',
description: '아직 덜 자란 풋아몬드로 만들어, 동그랗고 솜털이보송보송한 아기 솟대.\n날갯짓을 하기에는 아직 어려서, 가족들 품에 쏙 들어가 세상을 누비고 있다.\n솟대 가족의 사랑을 먹고 무럭무럭 자라는 중이라고.'
},
{
id: 'tr_ga001',
name: '연기의 비법이 담긴 마법책',
...
method: '최고급 보물 상자에서 획득',
description: '어딜 가든 젤리가 따라오는 것이 고민인 쿠키들을위해 만들어진 장갑.\n이 장갑만 있다면 젤리가 산더미처럼 쌓여있는 곳도 편하게 지나갈 수 있다고!'
},
{
id: 'tr_ga194',
name: '하이퍼 탄산\n드링크 제로',
rarity: 'S',
canEvolve: true,
effect: '초미니자력\n강화 수치에 따라 생명물약 획득시 거대화 1~2초',
method: '최고급 보물 상자에서 획득',
description: '불필요한 성분을 모두 덜어내 심플하지만 강력한끝맛을 가진 특별한 탄산 드링크.\n쿠키들 사이에서제로 음료 트렌드를 이끈 주역이다.'
},
{
id: 'tr_ga180',
name: '탱글탱글\n매실 탱탱볼',
rarity: 'S',
canEvolve: true,
effect: '충돌 직전 모든 장애물을 파괴 1회\n강화 수치에 따라 모든 젤리 70~250점 추가',
method: '최고급 보물 상자에서 획득',
description: '탱글 탱글한 매실에 젤리 시럽을 듬뿍 바르고 말려만든 단단한 매실탱탱볼.\n어디에서든 떨어트려도통통 튀어 올라온다.'
},
// 所持効果
{
id: 'tr_level_01',
...
rarity: 'S',
canEvolve: true,
effect: '2026년 7월 31일까지 출석시 6%\n확률로 11,000 코인 획득',
method: '눈덩이 모으기\n이벤트 보상으로 획득',
description: '눈송이에 따뜻한 불빛이 물들어 반짝반짝 빛나는 금빛 눈꽃송이가 되었다.\n너무 따뜻한 곳에 두면 녹을수 있으니 조심!\n*판매시 재구매가 불가능한 보물입니다.',
hasPassiveTag: true,
booknone: true
},
],
...
rarity: 'S',
canEvolve: true,
effect: '자력차단\n강화 수치에 따라 체력감소 7.5~10.5% 느림',
method: '자력 봉쇄 안전 장갑 진화하여 획득',
description: '고급 절연 소재로 만들어 두꺼워도 땀이 차지 않고, 백만볼트급 전류가 흘러도 끄떡 없다.\n수준급의 기술을 가진 쿠키들만이 이 장갑의 진가를 알고있다고...',
baseId: 'tr_ga193'
},
{
id: 'tr_ga194_m',
...
rarity: 'S',
canEvolve: true,
effect: '초미니자력\n강화 수치에 따라 생명물약 획득시 거대화 1.9~2.8초',
method: '하이퍼 탄산 드링크 제로 진화하여 획득',
description: '탄산 마니아들을 위해 불필요한 성분은 모두 빼고, 오직 탄산에만 집중한 드링크.\n한 입만 마셔도 입안에서 톡톡 튀는 힘이 요동친다!',
baseId: 'tr_ga194'
},
{
id: 'tr_ga180_m',
...
rarity: 'S',
canEvolve: true,
effect: '충돌 직전 모든 장애물을 파괴 2회\n강화 수치に 따라 모든 젤리 370~650점 추가',
method: '탱글탱글 매실 탱탱볼 진화하여 획득',
description: '두드리면 통통 소리가 나는 잘익은 수박만 고르고골라 통통 튀는 탄성에 강력함을 더했다!\n어떤 장애물이든 날려주마!',
baseId: 'tr_ga180'
},
],
// 祝福宝物（祝福後）
...
{
id: 'tr_ga193_m_blessed',
name: '튼튼 자력 차단\n장갑',
rarity: 'S',
effect: '자력차단\n강화 수치에 따라 체력감소 8.5~11.5% 느림',
method: '자력 봉쇄 안전 장갑 진화하여 획득',
description: '고급 절연 소재로 만들어 두꺼워도 땀이 차지 않고, 백만볼트급 전류가 흘러도 끄떡 없다.\n수준급의 기술을 가진 쿠키들만이 이 장갑의 진가를 알고있다고...',
baseId: 'tr_ga193_m'
},
{
id: 'tr_ga194_m_blessed',
name: '하이퍼 네온\n탄산 드링크 제로',
rarity: 'S',
effect: '초미니자력\n강화 수치에 따라 생명물약 획득시 거대화 2.1~3초',
method: '하이퍼 탄산 드링크 제로 진화하여 획득',
description: '탄산 마니아들을 위해 불필요한 성분은 모두 빼고, 오직 탄산에만 집중한 드링크.\n한 입만 마셔도 입안에서 톡톡 튀는 힘이 요동친다!',
baseId: 'tr_ga194_m'
},
{
id: 'tr_ga180_m_blessed',
name: '둥글둥글\n수박 탱탱볼',
rarity: 'S',
effect: '충돌 직전 모든 장애물을 파괴 2회\n강화 수치に 따라 모든 젤리 470~750점 추가',
method: '탱글탱글 매실 탱탱볼 진화하여 획득',
description: '두드리면 통통 소리가 나는 잘익은 수박만 고르고골라 통통 튀는 탄성에 강력함을 더했다!\n어떤 장애물이든 날려주마!',
baseId: 'tr_ga180_m'
},
