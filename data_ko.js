...
rarity: 'A',
canEvolve: true,
effect: '강화 수치에 따라 장애물 파괴시 500~600점 추가',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 장애물 파괴시 700~1000점 추가',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 기본속도 3~4% 증가\n강화 수치에 따라 장애물 파괴시 1000~1500점 추가',
...
rarity: 'S',
canEvolve: true,
effect: '광속질주시 장애물 통과\n강화 수치에 따라 장애물 통과시 500~1000점 추가',
...
rarity: 'S',
canEvolve: false,
effect: '강화 수치에 따라 장애물 파괴시 400~800점 추가\n강화 수치에 따라 기본속도 3~5% 증가',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 장애물 통과시 500~700점 추가',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 장애물 통과시 500~1500점 추가',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 장애물 파괴시 1500~2000점 추가',
method: '최고급 보물 상자에서 획득',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 장애물 통과시 1000~2000점 추가',
method: '최고급 보물 상자에서 획득',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 장애물 파괴시 500~1000점 추가\n강화 수치에 따라 모든 젤리 15~25점 추가',
method: '최고급 보물 상자에서 획득',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 장애물 파괴시 1000~2500점 추가\n강화 수치에 따라 광속질주 속도 5~10% 증가',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 장애물 파괴시 1700~3200점 추가',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 모든 젤리 60~123점 추가\n초미니자력',
...
rarity: 'S',
canEvolve: true,
effect: '체력감소 7% 느림\n강화 수치에 따라 장애물 통과시 1700~2300점 추가',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 장애물 통과시 1300~2800점 추가',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 장애물 통과시 1700~3200점 추가',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 모든 젤리 80~130점 추가\n강화 수치에 따라 기본속도 6~11% 증가',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 장애물 파괴시 1000~3500점\n추가',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 장애물 파괴시 1600~3500점\n추가',
...
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 장애물 통과시 2000~3500점\n추가',
...
{
id: 'tr_ga079_m',
name: '눈물콧물 쏙빠지는 와사비 캡스틱',
rarity: 'S',
canEvolve: true,
effect: '강화 수치에 따라 경험치 13~23% 보너스\n강화 수치에 따라 체력 20~30으로 부활 2회',
method: '정신이 번쩍드는 와사비 캡스틱 진화하여 획득',
description: '슬픈 일이 있을 때 일부러 이 캡스틱을 바르고 맘껏 울어도 좋다.',
baseId: 'tr_ga079'
},
{
id: 'tr_ga080_m',
...
description: '참을 수 없이 맵고 화끈한 드링크. 마시면 저절로 외치게 된다. 핫핫씁씁슈비루왑빠쏭!',
baseId: 'tr_ga096'
},
{
id: 'tr_ga100_m',
...
description: '달콤함 속에 상큼함이 감돈다. 잘 구워진\n골든키위가 입에서 살살 녹는 맛!',
baseId: 'tr_ga116'
},
{
id: 'tr_ga117_m',
...
rarity: 'S',
effect: '강화 수치에 따라 장애물 파괴시 1500~3000점 추가\n강화 수치에 따라 광속질주 속도 5~10% 증가',
method: '근육맛 쿠키의 단백질 파우더 진화하여 획득',
description: '이 파우더를 섭취하면 장애물 앞에서도 당당할 수 있다. 아무리 많이 먹어도 부작용이 없으니 안심하자.',
baseId: 'tr_ch15_m'
},
...
rarity: 'S',
effect: '강화 수치에 따라 장애물 파괴시 1700~3700점 추가',
method: '특전사맛 쿠키의 초콜릿 위장 크림 진화하여 획득',
description: '땀에도 비에도 지워지지 않는 강력한 위장 크림.',
baseId: 'tr_ch21_m'
},
...
rarity: 'S',
effect: '강화 수치에 따라 장애물 파괴시 2200~3700점 추가',
method: '체리맛 쿠키의 파티용 컵케이크 진화하여 획득',
description: '구하기 힘든 재료로 일년에 한 번 정성스레 만드는 특별한 케이크이다.',
baseId: 'tr_ch28_m'
},
...
rarity: 'S',
effect: '강화 수치에 따라 모든 젤리 70~133점 추가\n초미니자력',
method: '슈크림맛 쿠키의 슈모자 진화하여 획득',
description: '슈크림이 절대 손에 묻을 일이 없다! 한입에 쏘옥~',
baseId: 'tr_ch48_m'
},
...
rarity: 'S',
effect: '체력감소 7% 느림\n강화 수치에 따라 장애물 통과시 1800~2400점 추가',
method: '양파맛 쿠키의 눈물에 젖은 베개 진화하여 획득',
description: '악몽에서 벗어나 좀 더 편안한 잠을 자기 위해 마련한 레이스 베개. 하지만 여전히 가끔 눈물을 흘린다.',
baseId: 'tr_ch58_m'
},
...
rarity: 'S',
effect: '5% 확률로 젤리코가 떨어짐\n강화 수치에 따라 장애물 파괴시 800~1300점 추가',
method: '젤리코 큐브의 길잃은 젤리코 진화하여 획득',
description: '너무 오래 길을 잃고 방황했는지, 예전의 밝은 모습이 사라졌다. 하지만 강해진 느낌.',
baseId: 'tr_pet24_m'
},
...
rarity: 'S',
effect: '강화 수치에 따라 장애물 통과시 1800~3300점 추가',
method: '불꽃박쥐의 영원한 불씨 진화하여 획득',
description: '마음에 타오르는 불꽃도 이 불꽃처럼 영원히 꺼지지 않았으면...',
baseId: 'tr_pet28_m'
},
...
rarity: 'S',
effect: '강화 수치에 따라 장애물 통과시 2200~3700점 추가',
method: '보라보라 향초의 아직 따뜻한 촛농 진화하여 획득',
description: '아직 따뜻할 때 촛농을 다듬어 장미를 만들었다. 처음에는 악소리가 나게 뜨겁지만 금방 괜찮아진다고.',
baseId: 'tr_pet41_m'
},
...
rarity: 'S',
effect: '강화 수치에 따라 모든 젤리 100~150점 추가\n강화 수치에 따라 기본속도 8~13% 증가',
method: '찹쌀 하프물범의 단팥 통조림 진화하여 획득',
description: '반짝이는 금빛 캔이라 찹쌀 하프물범이 더욱더 소중하게 보관하고 있는 이 세상 최고의 팥으로 만든 팥 통조림',
baseId: 'tr_pet74_m'
},
...
name: '축복받은 파.괴.신의\n돌망치',
rarity: 'S',
effect: '강화 수치에 따라 장애물 파괴시 1500~4000점\n추가',
method: '파.괴.신의 뿅망치 진화하여 획득',
description: '파.괴.신이 어느날 새로 들고 온 망치. 참\n단단하게도 생겼다.',
baseId: 'tr_ga046_m'
},
...
name: '축복받은 무적의\n강철 핫도그',
rarity: 'S',
effect: '강화 수치에 따라 장애물 파괴시 2100~4000점\n추가',
method: '돌로 만든 핫도그 진화하여 획득',
description: '자, 이제 각오가 되었다면 씹고 뜯고 맛보고\n즐기자.',
baseId: 'tr_ga056_m'
},
...
name: '축복받은 어둠을 삼키는\n투명랜턴',
rarity: 'S',
effect: '강화 수치에 따라 장애물 통과시 2500~4000점\n추가',
method: '캠핑용 불꽃랜턴 진화하여 획득',
description: '삼켜진 어둠은 어디로 가기에 아직도 랜턴이\n투명한걸까?',
baseId: 'tr_ga060_m'
},
